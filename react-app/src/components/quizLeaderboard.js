...
class Quiz_Leaderboard extends Component {
    constructor() {
        super();
        this.state = {
                data : [],
    ...
    componentDidMount = () => {
        let url = 'http://127.0.0.1:8080/quizLeaderboard/' + this.props.match.params.qzid
                ...
                <div>
                    ...
                    <div className = "container">
                        ...
                        <div className = "row justify-content-center">
                            <h2 className = "style-1 mt-5">Quiz Leaderboard</h2>
                        </div>
...
export default Quiz_Leaderboard;