...
class Overall_Leaderboard extends Component {
    constructor() {
        super();
        this.state = {
                data : [],
    ...
    componentDidMount = () => {
        let url = 'http://127.0.0.1:8080/overallLeaderboard'
                ...
                <div>
                    ...
                    <div className = "container">
                        ...
                        <div className = "row justify-content-center">
                            <h2 className = "style-1 mt-5">Overall leaderboard </h2>
                        </div>
...
export default Overall_Leaderboard;